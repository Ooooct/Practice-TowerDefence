...
[CreateAssetMenu(fileName = "BulletCarryEffect", menuName = "Buffs/Effects/BulletCarryEffect")]
public class BulletCarryEffect : BuffEffectBase
{
    [SerializeField] private string m_carryBuffName;
    ...
    {
        evt.attackData.applyBuffs = new List<string>()
        {
            m_carryBuffName
        };
    }
